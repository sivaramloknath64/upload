...
namespace SmartStore.Web.Controllers
{
    public partial class OrderController : PublicControllerBase
    {
		...
		public ActionResult Print(int id)
		{
			...
			return PrintCore(new List<OrderDetailsModel> { model }, fileName);
		}

		[AdminAuthorize]
        [Permission(Permissions.Order.Read)]
		public ActionResult PrintMany(string ids = null)
		{
			...
			return PrintCore(listModel, "orders.pdf");
		}

		[NonAction]
		private ActionResult PrintCore(List<OrderDetailsModel> model,  string pdfFileName)
		{			
