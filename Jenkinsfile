			...
			steps{
				...
				stage('Build') {
    					steps {
                                        echo " building "
						bat label: '', script: '''
\\"${tool \\\'v16\\\'}\\" SmartStoreNET.proj /p:SlnName=SmartStoreNET /t:clean;build;package /p:PackageFileName="C:\\Users\\sivaram  loknath\\.jenkins\\workspace\\TestJenkins\\TestJenkins.zip  /p:Configuration=Release
'''
}
